...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
    ...
    <link rel="icon" href="img/logovb.jpg" type="image/jpg" sizes="16x16">
  ...
  <body>
    <div id="ful">
      <div id="header">
        ...
        <div id="nav">
          <ul id="menu">
          <li><button class="nb" id="nb3"><a href="log.html" target="_self"><i class="fas fa-user"></i>login</a></button></li>
      ...
      <!__coding page__>
        <div id="code">
          ...
          <div id="meslog"><h2>do need source code,please <a id="sor" href="log.html"><button id=btnl>login</button></a> </h2></div>
          <div id="java1">
                    <?php
...
$sql = "SELECT head, program FROM java";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
  while($row = $result->fetch_assoc()) {
    echo "<details><summary>".$row["head"]."</summary><section><p>".$row["program"]."</p></section></details>";
  }
} else {
  echo "0 results";
}
...
$sql = "SELECT head, program FROM web";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
  while($row = $result->fetch_assoc()) {
    echo "<details><summary>".$row["head"]."</summary><section><p>".$row["program"]."</p></section></details>";
        ...
        <div id="home">
          ...
          <div id="vtta">
            ...
            <p id="p1">
              ...
              viber tech tamil is now web application.yes,our thougt is every one be a programmer is our aim but we don't do nothing without your help. we need your help but not finacialy,we need ypur support only.please see the page content and see the coding.
          </p>
          </div>
          <div id="htmlp">
